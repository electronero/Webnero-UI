...
var ModelViewController = {
    ...
    fillData: function(){      
        ...
        if(etnxData != null){
            const etnxLockedBalance = parseFloat(this.formatCoinUnits(etnxData.balances.balance, "etnx")).toFixed(6)
        ...
        if(etnxpData != null){
            const etnxpLockedBalance = parseFloat(this.formatCoinUnits(etnxpData.balances.balance, "etnxp")).toFixed(6)
        ...
        if(crfiData != null){
            const crfiLockedBalance = parseFloat(this.formatCoinUnits(crfiData.balances.balance, "crfi")).toFixed(6)
        ...
        if(ltnxData != null){
            const ltnxLockedBalance = parseFloat(this.formatCoinUnits(ltnxData.balances.balance, "ltnx")).toFixed(6)
        ...
        if(gldxData != null){
            const gldxLockedBalance = parseFloat(this.formatCoinUnits(gldxData.balances.balance, "gldx")).toFixed(6)
